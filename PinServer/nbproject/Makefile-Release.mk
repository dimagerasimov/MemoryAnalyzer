...
${OBJECTDIR}/gdb_loader.o: gdb_loader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdb_loader.o gdb_loader.cpp
...
${OBJECTDIR}/map_clients.o: map_clients.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/map_clients.o map_clients.cpp

${OBJECTDIR}/notice_manager.o: notice_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/notice_manager.o notice_manager.cpp

${OBJECTDIR}/parser_protocol.o: parser_protocol.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parser_protocol.o parser_protocol.cpp

${OBJECTDIR}/pin_loader.o: pin_loader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pin_loader.o pin_loader.cpp
...
${OBJECTDIR}/thread_client.o: thread_client.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread_client.o thread_client.cpp

${OBJECTDIR}/utf_text.o: utf_text.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utf_text.o utf_text.cpp
...
${TESTDIR}/tests/parser_protocolTests.o: tests/parser_protocolTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/parser_protocolTests.o tests/parser_protocolTests.cpp


${TESTDIR}/tests/pin_serverTests.o: tests/pin_serverTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/pin_serverTests.o tests/pin_serverTests.cpp
...
${OBJECTDIR}/gdb_loader_nomain.o: ${OBJECTDIR}/gdb_loader.o gdb_loader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdb_loader_nomain.o gdb_loader.cpp;\
	else  \
...
${OBJECTDIR}/map_clients_nomain.o: ${OBJECTDIR}/map_clients.o map_clients.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/map_clients_nomain.o map_clients.cpp;\
	else  \
...
${OBJECTDIR}/notice_manager_nomain.o: ${OBJECTDIR}/notice_manager.o notice_manager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/notice_manager_nomain.o notice_manager.cpp;\
	else  \
...
${OBJECTDIR}/parser_protocol_nomain.o: ${OBJECTDIR}/parser_protocol.o parser_protocol.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parser_protocol_nomain.o parser_protocol.cpp;\
	else  \
...
${OBJECTDIR}/pin_loader_nomain.o: ${OBJECTDIR}/pin_loader.o pin_loader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pin_loader_nomain.o pin_loader.cpp;\
	else  \
...
${OBJECTDIR}/thread_client_nomain.o: ${OBJECTDIR}/thread_client.o thread_client.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread_client_nomain.o thread_client.cpp;\
	else  \
...
${OBJECTDIR}/utf_text_nomain.o: ${OBJECTDIR}/utf_text.o utf_text.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utf_text_nomain.o utf_text.cpp;\
	else  \
